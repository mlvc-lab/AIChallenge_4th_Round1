...
python main.py things --datapath /dataset/things_v4 -j 8 -a rexnet --width-mult 1.0 --depth-mult 1.0 -C -g 0 1 --save rexnet_1.0_v4_quant1.pth --load rexnet_1.0.pth --transfer --src-dataset imagenet \
