...
def get_same_padding_conv2d(image_size=None, mnn=None):
    ...
    if image_size is None:
        return mnn.MaskConv2dDynamicSamePadding
    else:
        return partial(mnn.MaskConv2dStaticSamePadding, image_size=image_size)
