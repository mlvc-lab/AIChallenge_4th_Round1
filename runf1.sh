...
python main.py things --datapath /dataset/things_v4 -j 8 -a rexnet --width-mult 1.0 --depth-mult 1.0 -C -g 0 1 --save cutmix_0.5_upgrade_tuned1.pth --load cutmix_0.5_upgrade.pth \
